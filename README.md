...
- מקור האמת: `docs/spec.md` (מסמך האפיון). סטיות: `DEVIATIONS.md`. התקדמות: `docs/progress.md`. מדריך למשתמש: `docs/user-guide-he.md`.
...
1. Supabase: פרויקט Postgres, הפעלת PITR, buckets פרטיים נוצרים אוטומטית (`ensureBuckets`) או ידנית: `contracts, invoices, supplier-invoices, general-docs, signatures, company, imports, report-exports`.
...
5. הרצת migrations: `DIRECT_URL=... pnpm db:migrate && pnpm db:seed`.
